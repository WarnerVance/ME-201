...
One of the key findings of an assessment was that of the string strength which was a chief variable in the amount of mass our crane could lift, for if the string breaks, it proves itself a futile material. 
